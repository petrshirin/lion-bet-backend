...
class Match(models.Model):
    ...
    score_full = models.CharField(max_length=30, default='0:0', verbose_name=u'Полный счет')
    score_period = models.CharField(max_length=30, default='0:0', verbose_name=u'Счет по периодам')
    period_name = models.CharField(max_length=30, default='line', verbose_name=u'Текущий период')
    request_type = models.CharField(max_length=4, default='line', verbose_name=u'Тип')
    deleted = models.BooleanField(default=False, verbose_name=u'Удален')
